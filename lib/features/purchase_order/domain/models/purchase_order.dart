...
import 'purchase_order_approval.dart';
...
class PurchaseOrder extends Equatable {
  ...
  factory PurchaseOrder.fromJson(Map<String, dynamic> json) {
    return PurchaseOrder(
      id: json['id'] as int,
      purchaseRequestId: json['purchase_request_id'] as int?,
      ...
      details: (json['details'] as List<dynamic>?)
              ?.map((d) => PurchaseOrderDetail.fromJson(d as Map<String, dynamic>))
              .toList() ??
          [],
      approvals: (json['approvals'] as List<dynamic>?)
              ?.map((a) => PurchaseOrderApproval.fromJson(a as Map<String, dynamic>))
              .toList() ??
          [],
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'purchase_request_code': purchaseRequestCode,
      'date': date,
      'code': code,
      'supplier': supplier,
      'notes': notes,
  ...
  PurchaseOrder copyWith({
    ...
    List<PurchaseOrderApproval>? approvals,
    String? createdAt,
    String? updatedAt,
  }) {
    return PurchaseOrder(
      ...
      purchaseRequestCode: purchaseRequestCode ?? this.purchaseRequestCode,
      date: date ?? this.date,
      code: code ?? this.code,
