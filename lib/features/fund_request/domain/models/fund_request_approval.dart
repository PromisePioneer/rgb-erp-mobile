...
/// Represents an approval record for a Fund Request
class FundRequestApproval extends Equatable {
  final int id;
  final int level;
  final String status;
  final String? note;
  ...
  factory FundRequestApproval.fromJson(Map<String, dynamic> json) {
    return FundRequestApproval(
      id: json['id'] as int,
