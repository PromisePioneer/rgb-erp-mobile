...
/// Represents an approval record for a Reception
class ReceptionApproval extends Equatable {
  final int id;
  final int level;
  final String status;
  final String? note;
  ...
  factory ReceptionApproval.fromJson(Map<String, dynamic> json) {
    return ReceptionApproval(
      id: json['id'] as int,
