...
class _ReceptionScreenState extends State<ReceptionScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      notifier.loadReceptions(refresh: true);
  ...
  void _onSearch(String query) {
    context.read<ReceptionNotifier>().applyFilters(
    ...
    return TopGradientBackground(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          child: Column(
            ...
            children: [
              ...
              // List
              Expanded(
                child: Consumer<ReceptionNotifier>(
        ...
        floatingActionButton: Padding(
          ...
          child: _FAB(
            onPressed: () => context.push('/reception/form'),
            icon: IconMap.plus,
            label: 'Buat GR',
          ),
        ),
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(
              ...
              child: PrimaryButton(
                label: 'Coba Lagi',
                onPressed: () => notifier.loadReceptions(refresh: true),
              ),
            ),
          ],
        ),
  ...
  Widget _buildEmptyState() {
    return Center(
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Icon(IconMap.inventory, size: 64, color: AppColors.slate300),
  ...
  Widget _buildList(List<Reception> items, bool hasMore) {
  ...
  Widget _buildCard(Reception reception) {
    final statusColor = _getStatusColor(reception.status);
    final statusBg = _getStatusBg(reception.status);
    ...
    return Container(
      ...
      child: Material(
        ...
        child: InkWell(
          borderRadius: BorderRadius.circular(16),
          onTap: () => context.push('/reception/${reception.id}'),
          child: Padding(
            padding: const EdgeInsets.all(16),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...
                if (reception.purchaseOrderCode != null) ...[
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        'PO: ${reception.purchaseOrderCode}',
                        style: const TextStyle(
                          fontSize: 13,
